...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Local environments can use Telescope normally. For shared/staging
    | environments, the gate also allows owner users and the comma-separated
    | email addresses listed here.
    |
    */

    'allowed_emails' => array_filter(array_map('trim', explode(',', env('TELESCOPE_ALLOWED_EMAILS', '')))),

    'allow_owner_role' => env('TELESCOPE_ALLOW_OWNER_ROLE', true),
