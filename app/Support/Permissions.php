...
class Permissions
{
    ...
    public static function routeMap(): array
    {
        return [
            ...
            'catalog.modifier-groups.store' => 'items.edit',
            'catalog.modifier-groups.update' => 'items.edit',
            'catalog.modifier-groups.destroy' => 'items.delete',
            'catalog.modifier-groups.assign' => 'items.edit',
            'catalog.modifiers.store' => 'items.edit',
            'catalog.modifiers.update' => 'items.edit',
            'catalog.modifiers.destroy' => 'items.delete',
