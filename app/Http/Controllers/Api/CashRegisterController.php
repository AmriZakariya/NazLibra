        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(properties: [
                    ...
                    new OA\Property(property: 'session', type: 'object', nullable: true),
                ])
            ),
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    new OA\Property(property: 'opening_amount', type: 'number', format: 'float', example: 500.00),
    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    new OA\Property(property: 'counted_cash_amount', type: 'number', format: 'float', example: 650.00),
                    new OA\Property(property: 'closing_note', type: 'string', nullable: true),
                ]
            )
        ),
        tags: ['Cash Register'],
        ...
        responses: [
            ...
            new OA\Response(response: 422, description: 'No open session'),
            new OA\Response(response: 401, description: 'Unauthenticated'),
        ]
    )]
    ...
    #[OA\Post(
        ...
        responses: [
            new OA\Response(
                ...
                content: new OA\JsonContent(properties: [
                    new OA\Property(property: 'ok', type: 'boolean', example: true),
                    new OA\Property(property: 'movement', type: 'object'),
                ])
            ),
            new OA\Response(response: 422, description: 'No open session'),
            new OA\Response(response: 401, description: 'Unauthenticated'),
